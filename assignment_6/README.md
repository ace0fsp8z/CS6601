...
`git clone --recursive https://github.gatech.edu/omscs6601/assignment_6.git`
...
# Submit your code
A friendly reminder: please ensure that your submission is in `hmm.py`. The script described in the following section automatically sends that file to the servers for processing.

To submit your code and have it evaluated for a grade, use `python submit.py assignment_6`. The submit script described automatically sends that file to the servers for processing.