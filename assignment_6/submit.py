...
def display_assignment_6_output(submission):
...
def main():
  ...
  parser.add_argument('part', choices = ['assignment_6'])
  ...
  if args.part == 'assignment_6':
    display_assignment_6_output(submission)
  else:
